...
inWallet = [0, (0.01710293+0.019761+  0.03229029)]  #What I have in my wallets right now
...
#The density of my stocks
ranges = []

for i in range(len(investment)):
	if (investment[i][2] > 7000) and (investment[i][2] < 8000):
		ranges[0] = ranges[0] + investment [i][1]
		sys.stdout.write("dds")
		
	if (investment[i][2] > 8000) and (investment[i][2] < 9000):
		ranges[1] = ranges[1] + investment [i][1]
	if (investment[i][2] > 9000) and (investment[i][2] < 10000):
		ranges[2] = ranges[2] + investment [i][1]
		
	if (investment[i][2] > 10000) and (investment[i][2] < 11000):
		ranges[3] = ranges[3] + investment [i][1]
		sys.stdout.write("\n\n"+ str(len(ranges))+"\n\n")
	if (investment[i][2] > 11000) and (investment[i][2] < 12000):
		ranges[4] = ranges[4] + investment [i][1]
...
for i in range(len(ranges)):
	sys.stdout.write("~~~~~  $7000-8000: "+ ranges[0] + " BTC  ~~~~\n"+"\n\n")		
